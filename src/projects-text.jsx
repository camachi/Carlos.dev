...
{   
    return(
        ...
        <div className='projects-text-description'>
        <p>{description}</p>
        </div>
        ...
        <div className='projects-text-buttons'>
        {link && (
